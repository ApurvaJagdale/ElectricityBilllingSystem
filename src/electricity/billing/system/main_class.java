...
public class main_class extends JFrame implements ActionListener{
	...
	//private static final long serialVersionUID = 1L;
       main_class(String acctype,String meter_pass){
		...
		ImageIcon imageIcon = new ImageIcon(ClassLoader.getSystemResource("ebs.png"));
		...
		ImageIcon calculatebillImg = new ImageIcon(ClassLoader.getSystemResource("calculatebills.png"));
	...
	//    System.out.println("Image......: " + ClassLoader.getSystemResource("pay.png"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		System.out.println("In main_class msg...:"+msg);
