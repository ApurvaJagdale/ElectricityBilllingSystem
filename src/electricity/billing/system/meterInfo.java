...
public class meterInfo extends JFrame implements ActionListener{
	...
	meterInfo(String meternumber){
		...
		meterNumber.setBounds(50,80,110,20);
		...
		meterLoc.setBounds(50,120,110,20);
		panel.add(meterLoc);
		...
		meterTyp.setBounds(50,160,110,20);
		panel.add(meterTyp);
		...
		billTyp.setBounds(50,240,110,20);
		panel.add(billTyp);
		...
		panel.add(day);
		 ...
		 note.setBounds(50,320,110,20);
		 panel.add(note); 
		
		 JLabel note1 =new JLabel("By default bill is calculated for 30 days only");
		 note1.setBounds(50,340,310,20);
		 panel.add(note1); 
		
		submit = new JButton("Submit");
		submit.setBounds(220,390,110,25);
